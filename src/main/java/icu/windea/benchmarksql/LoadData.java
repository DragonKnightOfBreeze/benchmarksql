...
public final class LoadData {
    ...
    private static int warehouseStart;
    private static int warehouseEnd;
    private static ConcurrentLinkedQueue<Integer> warehouses;
    ...
    public static void main(String[] args) {
         ...
         */
        warehouseStart = iniGetInt("warehouseStart");
        warehouseEnd = iniGetInt("warehouseEnd");
        if(warehouseEnd > 0) {
            warehouses = new ConcurrentLinkedQueue<>();
            for(int n = warehouseStart; n <= warehouseEnd; n++) {
                warehouses.add(n);
            }
        }
